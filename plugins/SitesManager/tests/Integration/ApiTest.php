...
use Piwik\Piwik;
use Piwik\Plugin;
use Piwik\Plugins\MobileAppType;
...
class ApiTest extends IntegrationTestCase
{
    ...
    public function testAddSite_ShouldSavePassedPropertySettings_IfSettingsAreValid()
    {
        $type = MobileAppType\Type::ID;
        ...
        $property = new Property($idSite);
        $appId    = $property->getSettingValue('app_id');
    ...
    public function testUpdateSite_ShouldFailAndNotUpdateSiteIfASettingIsInvalid()
    {
        ...
        try {
            ...
            $property = new Property($idSite);
            $this->assertNotEquals('newSiteName', $property->getName());

            throw $e;
        }
    }

    public function testUpdateSite_ShouldSavePassedPropertySettings_IfSettingsAreValid()
    {
        $type = MobileAppType\Type::ID;
        $idSite = $this->addSiteWithType($type, array());
        ...
        $property = new Property($idSite);
        $this->assertSame('newSiteName', $property->getName());
        $this->assertSame('org.piwik.mobile2', $property->getSettingValue('app_id'));
    }
