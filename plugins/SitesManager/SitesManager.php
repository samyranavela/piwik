...
class SitesManager extends \Piwik\Plugin
{
    ...
    public function onSiteDeleted($idSite)
    {
        ...
        $propertyStorage = new Storage(Db::get(), $idSite);
        $propertyStorage->deleteAllValues();
    }
    ...
    public function getClientSideTranslationKeys(&$translationKeys)
    {
        ...
        $translationKeys[] = "SitesManager_AddProperty";
        $translationKeys[] = "SitesManager_AddSite";
        $translationKeys[] = "SitesManager_NewProperty";
        $translationKeys[] = "SitesManager_XManagement";
        $translationKeys[] = "SitesManager_ChoosePropertyTypeHeadline";
        $translationKeys[] = "General_Properties";
